...
LOSS_DATA_DIR = LOSS_DATA_DIR.replace('/home/vuminh/ros2_ws/src/reinforcement_learning', '/home/vuminh/ros2_ws/src/reinforcement_learning/log_data')
...
class MemoryBuffer():
    ...
    def sample(self, count):
        ...
        dones = np.bool_([array[4] for array in batch])
...
class DuelingQAgent():
    def __init__(self, state_size, action_size, mode, load_eps, handle: RosHandler):
        #self.pub_result = rospy.Publisher('result', Float32MultiArray, queue_size=5)
        self.handler = handle
        self.pub_result = self.handler.pub_result
        self.dirPath = os.path.dirname(os.path.realpath(__file__))
        self.dirPath = self.dirPath.replace('/home/vuminh/ros2_ws/src/reinforcement_learning', '/home/vuminh/ros2_ws/src/reinforcement_learning/log_data')
    ...
    def TrainModel(self):
        ...
        states = torch.tensor(states).view(32, 1, 144, 176)
        next_states = torch.tensor(next_states).view(32, 1, 144, 176)
        ...
        predicted_values = tung.gather(1, actions.view(32, 1, 1).expand(32, 1, tung.size(2))).squeeze()
